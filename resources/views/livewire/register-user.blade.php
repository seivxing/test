<div class="flex h-screen">
    ...
    <div class="w-full bg-gray-100 lg:w-1/2 flex items-center justify-center">
        <div class="max-w-md w-full p-6">
            <div style="position: absolute;top:60px;right:420px">

                <a href="{{ route('home') }}"><img width="100px" style="border-radius: 50%;"
                        src="{{ asset('bs5/image_title/btb-pc-logo.jpg') }}" alt=""></a>
            </div>
            <h1 class="text-3xl font-semibold mb-6 text-black text-center">Sign Up</h1>
            <h1 class="text-sm font-semibold mb-6 text-gray-500 text-center">Join now for exclusive deals on laptops
                and accessories! </h1>
            <form wire:submit.prevent="create">
                ...
                <div class="form-floating mb-3">
                    ...
                    @if ($recommendedEmail)
                        <span class="recommended-email">Recommended: {{ $recommendedEmail }}</span>
                    @endif
                    @error('email')
                        <p class="text-red-500">{{ $message }}</p>
                    @enderror
                ...
                <div class="form-group mb-3">
                    ...
                    @error('g_recaptcha_response')
                        <span class="text-blue-500">Please refresh the page for Captcha re-validation. Or u can just wait
                            30sec for submit the form again</span>
                    @enderror
                </div>
                ...
                <div class="mb-2">
                    <span class=" text-sm font-semibold" style="color: rgb(133, 130, 130) ;size:12px">Already have an
                        account?</span>
                    <span style="color:rgb(28, 27, 27); font-size: 14px; font-weight: bold;">
                        <a href="{{ route('login') }}" style="color: inherit; text-decoration: none;">Login
                            now</a>
                    </span>
                </div>
                <button type="submit"
