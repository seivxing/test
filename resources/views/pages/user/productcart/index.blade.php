...
@section('content')
    ...
    <header style="border-radius: 20px !important" class="site-navbar js-sticky-header site-navbar-target" role="banner">
                    ...
                    <nav class="site-navigation text-right ml-auto " role="navigation">
                        ...
                        <ul class="site-menu main-menu js-clone-nav ml-auto d-none d-lg-block">
                            ...
                            @auth
                                ...
                                <li><a class="nav-link active" href="{{ route('view_productcart') }}"><i
                                            class="fas fa-truck"></i>Cart
    ...
    <livewire:pages.user.productcart.product-cart-show />
@endsection
