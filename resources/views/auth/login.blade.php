    ...
    <div class="flex h-screen">
        ...
        <div class="w-full bg-gray-100 lg:w-1/2 flex items-center justify-center">
            <div class="max-w-md w-full p-6">
                ...
                <h1 class="text-sm font-semibold mb-6 text-gray-500 text-center">Unlock exclusive deals and offers by
                    logging in to your account today! </h1>
                @if (session('error'))
                ...
                <form action="{{ route('login_submit') }}" method="post">
                    ...
                    <div class="mb-2">
                        <span class=" text-sm font-semibold" style="color: rgb(133, 130, 130) ;size:12px">Doesn't have
                            any
                            account ?</span>
                        <span style="color:rgb(28, 27, 27); font-size: 14px; font-weight: bold;">
                            <a href="{{ route('register') }}" style="color: inherit; text-decoration: none;">Register
                                now</a>
                        </span>
                    </div>
                    <button type="submit"
